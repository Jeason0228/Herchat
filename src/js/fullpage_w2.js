function get_w(gt, challenge, s) {
    ...
    //     "type" : what,
    //     "gt" : data[String(65)],
    //     "challenge" : data[fn(127)],
    //     "lang" : data[String(241)],
    //     "https" : data[fn(1253)],
    //     "protocol" : data[String(33)],
    //     "offline" : data[fn(182)],
    //     "product" : data[String(1201)],
    //     "skin_path" : data[String(1482)],
    //     "api_server" : data[String(196)],
    //     "static_servers" : data[String(699)],
    //     "timeout" : data[String(44)],
    //     "post" : data[fn(99)],
    //     "debugConfig" : data[fn(1409)],
    //     "$" : resolve,
    //     "isPC" : true,
    //     "hideSuccess" : data[fn(1472)],
    //     "remUnit" : data[fn(1291)],
    //     "zoomEle" : data[String(1440)],
    //     "hideClose" : data[fn(1463)],
    //     "hideRefresh" : data[fn(1478)],
    //     "autoReset" : data[fn(1464)]
    //   };
